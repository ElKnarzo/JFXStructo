...
public class MainController extends JFXBaseController {
	...
	@FXML
	private MenuItem menuNewFile, menuSaveFile, menuSaveFileAs, menuOpenFile, menuCloseFile, menuQuit;
	@FXML
...
//					createNewDiagram();
	...
	private void newFile() {
		try {
			...
			loader.setLocation(getClass().getResource("/de/jfxstructo/gui/newTab.fxml"));
			...
			diagram.getCanvas().addEventHandler(MouseEvent.MOUSE_MOVED, new DiagramMouseMoveListener(lblStatus));
	...
	private void onMenuStructureClick(ActionEvent event) {
		Stage s = new Stage();
		PreferenceController.initStage(s, "/de/jfxstructo/gui/Preferences.fxml", new PreferenceController(), false);
